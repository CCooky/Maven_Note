...
1. **选择使用Web项目骨架**
   ...
   ![1627227650406](../../Java笔记/JavaWeb_Note/images/1627227650406-164406993760134.png)

2. 输入Maven项目坐标创建项目

   ![1627228065007](../../Java笔记/JavaWeb_Note/images/1627228065007-164406993760135.png)

3. 确认Maven相关的配置信息后，完成项目创建

   ![1627228413280](../../Java笔记/JavaWeb_Note/images/1627228413280-164406993760136.png)
...
之前我们的SSM开发是一个人做完，且是左边的结构。这样还是不适合多人开发，是不是我们可以把里面的每个功能区都拆分成单独的模块呢！！！答案是可以滴拉。

<img src="images/image-20220325185241642.png" alt="image-20220325185241642" style="zoom:80%;" />
